...
function custom_themes_assets() {
    if(is_page_template('home.php')) {
        ...
        wp_enqueue_style( 'header-project', get_template_directory_uri().'/build/style/header.min.css' );
        wp_enqueue_script('dropdown-project', get_template_directory_uri().'/build/js/dropdownmenu.js' );
