<section class="form-project1 container">
    <div class="form-project-title">
        <p>Hmmmm</p>
        <h2>Inscreva-se e receba lanches de graça toda semana!</h2>
    </div>
    <form action="">
        <input type="text" />
        <input type="text" />
    ...
    <button class="button-yellow">
        <svg fill="#000000" height="20px" width="18px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
